...
static inline OBX_model* create_obx_model() {
    ...
    obx_model_entity(model, "Task", 1, 7226670828243041227);
    obx_model_property(model, "id", OBXPropertyType_Long, 1, 6844839685842414345);
    obx_model_property_flags(model, OBXPropertyFlags_ID);
    obx_model_property(model, "text", OBXPropertyType_String, 2, 2262982720104998269);
    obx_model_entity_last_property_id(model, 2, 2262982720104998269);
    
    obx_model_last_entity_id(model, 1, 7226670828243041227);
